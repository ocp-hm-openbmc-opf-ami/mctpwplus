...
int main(int argc, char* argv[])
{
    ...
    MCTPConfiguration vdpciConfig(mctpw::MessageType::spdm,
                                  mctpw::BindingType::mctpOverSmBus);
    ...
    boost::asio::spawn(
        io, [eid, &mctpWrapper1](boost::asio::yield_context yield) {
            mctpWrapper1.detectMctpEndpoints(yield);
            std::cout << "Registering a SMBus SPDM responder" << std::endl;
    ...
    boost::asio::spawn(
        io, [eid, &mctpWrapper2](boost::asio::yield_context yield) {
            mctpWrapper2.detectMctpEndpoints(yield);
            std::cout << "Registering a VDPCI PLDM responder" << std::endl;
